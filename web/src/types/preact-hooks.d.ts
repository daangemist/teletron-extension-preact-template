// A types definition file for the preactHooks module. This is necessary to silence the error
// that the module is missing. preact/hooks is not directly included as a package, since we use
// preact from a global variable, from the base teletron project.

declare module 'preactHooks' {
